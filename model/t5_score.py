...
import torch
from transformers.models.mt5.modeling_mt5 import MT5PreTrainedModel, MT5Stack, CrossEntropyLoss, warnings, BaseModelOutput, Seq2SeqLMOutput, logger
import copy
...
PARALLELIZE_DOCSTRING = r"""
    ...
    model = MT5ForConditionalGeneration.from_pretrained('t5-3b')
    device_map = {0: [0, 1, 2],
             1: [3, 4, 5, 6, 7, 8, 9],
...
class MyMT5ForConditionalGenerationScore(MT5PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Examples::
            ...
            >>> from transformers importMT5Tokenizer, MT5ForConditionalGeneration

            >>> tokenizer =MT5Tokenizer.from_pretrained('t5-small')
            >>> model = MT5ForConditionalGeneration.from_pretrained('t5-small', return_dict=True)
